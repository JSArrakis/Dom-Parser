...
document.addEventListener('DOMContentLoaded', function () {
    ...
    chrome.tabs.query({ active: true, currentWindow: true }, function (tabs) {
        ...
        chrome.runtime.sendMessage({ 'request': 'getData' }, LayoutReceived);
...
function LayoutReceived(Response) {
    ...
    //alert(JSON.stringify(Response.Values));
...
function DisplayField(Field, Depth) {
    return "<span>" + CreatePad(Depth) + "<i>" + Field.Name + ":</i> " + Field.Value + "</span><br />";
}
